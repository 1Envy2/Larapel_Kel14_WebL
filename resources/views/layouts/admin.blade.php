...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-gray-50">
        <div class="min-h-screen flex">
            ...
            <aside class="w-64 bg-white border-r border-gray-200 shadow-sm fixed h-screen overflow-y-auto z-50">
                ...
                <nav class="mt-8">
                    ...
                    <!-- Donasi -->
                    <div class="mt-6">
                        <p class="px-6 text-xs uppercase font-semibold text-slate-400 mb-3">Donasi</p>
                    ...
                    <!-- Alokasi Dana -->
                    <div class="mt-6">
                        <p class="px-6 text-xs uppercase font-semibold text-slate-400 mb-3">Alokasi</p>
                    ...
                    <!-- Kampanye -->
                    <div class="mt-6">
                        <p class="px-6 text-xs uppercase font-semibold text-slate-400 mb-3">Kampanye</p>
                    ...
                    <div class="mt-6">
                        <form method="POST" action="{{ route('logout') }}" class="block">
                            @csrf
                            <button type="submit" class="w-full text-left px-6 py-3 text-slate-600 hover:text-slate-900 hover:bg-gray-50 transition duration-200 flex items-center gap-3">
