    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-lg shadow-md p-8">
                ...
                <div class="border-t border-gray-300 pt-10 pb-10 space-y-10">
                    <div class="text-center border-b border-gray-200 pb-10">
                        <p class="text-xs text-gray-600 font-semibold uppercase tracking-wide mb-3">Total Donasi</p>
                        <p class="text-3xl font-bold text-cyan-600">Rp{{ number_format(auth()->user()->getTotalDonated(), 0, ',', '.') }}</p>
                    </div>
                    <div class="text-center border-b border-gray-200 pb-10">
                        <p class="text-xs text-gray-600 font-semibold uppercase tracking-wide mb-3">Kampanye Didukung</p>
                        <p class="text-3xl font-bold text-gray-900">{{ auth()->user()->getCampaignsSupported() }}</p>
                    </div>
                    <div class="text-center">
                        <p class="text-xs text-gray-600 font-semibold uppercase tracking-wide mb-3">Donor Sejak</p>
