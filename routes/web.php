...
// Save campaign (Donor only)
Route::middleware(['auth', 'verified', 'donor'])->post('/campaigns/{campaign}/save', [CampaignController::class, 'save'])->name('campaigns.save');

// Comment on campaign (Donor only)
Route::middleware(['auth', 'verified', 'donor'])->post('/campaigns/{campaign}/comment', [CampaignController::class, 'comment'])->name('campaigns.comment');
